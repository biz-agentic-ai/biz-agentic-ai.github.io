...
> **관련 문서:** Implementation Strategy §14-17, Implementation Guide STEP 12-A
...
# 2. 이 템플릿을 규칙 파일로 복사
cp templates/CLAUDE_md_Template.md .claude/rules/datanexus.md
...
# 6. PROGRESS.md 마스터 파일 초기화 (프로젝트 루트)
cat > PROGRESS.md << 'EOF'
# DataNexus Progress Tracker
