...
| **쿼리 라우팅 정확도**<br>(Routing Accuracy) | 온톨로지 정보(정형/비정형 속성)를 기반으로 Router가 적절한 에이전트(Vanna vs ApeRAG)를 선택한 비율 | **목적:** 온톨로지가 질의 분해 및 라우팅의 '신호등' 역할을 제대로 수행하는지 검증합니다. |
...
> **📌 Phase 2+/3 내용 분리 안내**
>
> 아래 섹션들은 PRD_04c_Ontology_Future.md로 이관되었습니다:
...
>
> 자세한 내용은 [PRD_04c_Ontology_Future.md](./PRD_04c_Ontology_Future.md)를 참조하세요.
