...
Ahrefs Brand Radar 데이터 기준으로 YouTube는 현재 AI Overview에서 가장 많이 인용되는 도메인이다. 6개월 사이에 인용 점유율이 34% 성장했다. OtterlyAI가 1억 건 이상의 인용 데이터를 분석한 결과에서도 YouTube는 소셜 플랫폼 중 Reddit에 이어 2위를 차지했고, AI 인용의 31.8%를 가져갔다.

흥미로운 건 조회수가 많은 영상이 인용되는 게 아니라는 점이다. AI에 인용된 YouTube 영상 중 40.8%가 조회수 1,000 미만이었다. 36%는 좋아요가 15개도 안 됐다. AI는 인기도가 아니라 정보 구조를 본다. 타임스탬프, 챕터 구분, 명확한 제목 — 이런 요소가 인용 여부를 결정한다.
