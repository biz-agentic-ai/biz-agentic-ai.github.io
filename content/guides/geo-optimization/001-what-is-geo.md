...
<a href="/demo/geo-demo-a.html" target="_blank" rel="noopener" onclick="window.open(this.href, 'geo-demo', 'width=1200,height=800,scrollbars=yes,resizable=yes'); return false;"><strong>GEO 인터랙티브 데모 열기 - AI 검색 비교</strong></a>
